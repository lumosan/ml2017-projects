...
\section{Models and methods}
	...
	\label{sub:initial_data_parsing}
  	The Higgs boson dataset contains $250000$ observations and $30$ features. The variables take values in different ranges and some contain the value $-999$ for certain observations, which we consider to represent \emph{missing information}. %In some cases up to 29\% of the total observed data for a variable is missing.
	...
	\subsection{Cross validation and hyper-parameters tuning} % (fold)
