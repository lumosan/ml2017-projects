# Set of function definition to plot different results 
...
def cross_validation_visualization(lambds, mse_tr, mse_te):
	...
	----------
	lambds 
		List of lambdas on which plot the functions.
	mse_tr
    	List of mse values on training data on different lambdas (after all k-fold cycles)
    mse_te
    	List of mse values on test data on same conditions as before
    """
