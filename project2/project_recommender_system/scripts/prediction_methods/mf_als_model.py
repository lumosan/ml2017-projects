...
def model_mf_als(train_data, test_data, test_flag, prediction_path='',
    ...
    if test_flag:
        ...
        te_pred, te_vals = predict(test_data, False, 'model_mf_als_te')
        val_pred, val_vals = predict(validation_data, False, 'model_mf_als_val')
        ...
        te_pred, te_vals = predict(test_data, True, 'model_mf_als_sub')
